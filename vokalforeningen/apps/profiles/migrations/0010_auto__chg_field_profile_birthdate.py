...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'birthdate', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profile.birthdate'
        raise RuntimeError("Cannot reverse this migration. 'Profile.birthdate' and its values cannot be restored.")
