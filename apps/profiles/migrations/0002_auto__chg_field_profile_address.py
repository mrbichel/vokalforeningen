...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Profile.address'
        db.alter_column('profiles_profile', 'address', self.gf('django.db.models.fields.TextField')())
