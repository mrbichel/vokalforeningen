...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profiles_profile', 'member_since')
        ...
        db.add_column('profiles_profile', 'postal_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.municipality'
        db.add_column('profiles_profile', 'municipality', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Profile.experience'
        db.add_column('profiles_profile', 'experience', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.position'
        db.add_column('profiles_profile', 'position', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('profiles_profile', 'member_since', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)
        ...
        db.delete_column('profiles_profile', 'postal_code')

        # Deleting field 'Profile.municipality'
        db.delete_column('profiles_profile', 'municipality')

        # Deleting field 'Profile.experience'
        db.delete_column('profiles_profile', 'experience')

        # Deleting field 'Profile.position'
        db.delete_column('profiles_profile', 'position')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'municipality': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'postal_code': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
