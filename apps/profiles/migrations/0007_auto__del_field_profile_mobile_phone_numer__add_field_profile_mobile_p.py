...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.mobile_phone_number'
        db.add_column('profiles_profile', 'mobile_phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.mobile_phone_number'
        db.delete_column('profiles_profile', 'mobile_phone_number')
